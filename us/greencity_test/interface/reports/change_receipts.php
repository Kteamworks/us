...
<title><?php echo xlt('Edit Receipts') ?></title>
</head>
<body leftmargin='0' topmargin='0' marginwidth='0' marginheight='0' class="body_top">


<form method='post' action='change_receipts.php' id='theform'>
<div id="report_parameters">
<div id="hideonprint">
<input type='hidden' name='form_refresh' id='form_refresh' value=''/>
<input type='hidden' name='form_csvexport' id='form_csvexport' value=''/>
<input type='hidden' name='form_save' id='form_save' value=''/>
Enter Receipt Number to Change: <input type='text' name='receipt_change' id='receipt_change' value=''/><br/>
...
$billing="SELECT * from payments where receipt_id='$receipt_change'";
...
//$qry="UPDATE vouchers set voureverseYN='1'  where voucher_no='$voucher_no'";
	...
	//$r1=sqlStatement($qry);	  
$id="SELECT * from payments where receipt_id='$receipt_change'";
	  $id1=sqlStatement($id);
	  $id2=sqlFetchArray($id1);
	  if($id2['receipt_id']==null)
       {
	         echo( "Please Enter the Proper Receipt Number!" );
          }else{	
			sqlStatement("update payments set date='$datechange', user='".$_SESSION['authUser']."' where receipt_id='$receipt_change'");

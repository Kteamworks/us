...
//require_once("$srcdir/library/classes/postmaster.php"); 
...
$pdf->Output($_SERVER['DOCUMENT_ROOT'] . '/output.pdf', 'F');
    ...
    $message='';
    $mail = new MyMailer();
    $email_subject=xl('Test Prescription Attachment');
    $email_sender="chandnijoshi09@gmail.com";
...
$mail = new PHPMailer();                    
$mail->From = "chandnijoshi09@gmail.com";
$mail->FromName = "Your name";
$mail->AddAddress("chandnijoshi09@gmail.com");
$mail->AddReplyTo("chandnijoshi09@gmail.com", "Test");               
//$pdf->Output($_SERVER['DOCUMENT_ROOT'] . 'output.pdf', 'F');
//$fileroot=."/"."output.pdf";

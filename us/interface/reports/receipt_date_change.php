...
<title><?php echo xlt('Receipt Change') ?></title>
</head>
<body leftmargin='0' topmargin='0' marginwidth='0' marginheight='0' class="body_top">


<form method='post' action='receipt_date_change.php' id='theform'>
...
//$qry="UPDATE vouchers set voureverseYN='1'  where voucher_no='$voucher_no'";
	...
	//$r1=sqlStatement($qry);	  
$id="SELECT * from payments where receipt_id='$receipt_change' and activity='1'";
	  $id1=sqlStatement($id);

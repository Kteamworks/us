...
<div class="col-md-4" ng-app="ui.bootstrap.demo">
...
$qry = "SELECT provider_id,reason,encounter,sensitivity
FROM form_encounter
WHERE pid = ?
...
<li><a href="pnotes_full_add.php?<?php echo $urlparms; ?>" id="note" class="black-tooltip iframe" data-original-title="Tooltip on bottom" onclick='top.restoreSession()' data-toggle="tooltip" data-placement="bottom" title="Add Patient Notes"> <span class="fa-stack fa-lg">

...
jQuery('#form_em_postal_code').blur(function(){ //.postcode class of zipcode text field
var s = jQuery(this).val();
jQuery.ajax({
type: 'POST',
url: "http://greencity.medsmart.co.in/greencity/interface/new/insertzip.php",//file which read zip code excel file
...
//jQuery("#form_em_city").val(data.dist);//city-class of city text filed
//jQuery("#form_em_locality").val(""); //has arealist
//jQuery("#form_em_state").val(data.state);
//jQuery("#form_em_country").val('India');


<!--$("#form_em_locality").html("");
//$(“#ComboBox”).html(“”);
//$.each(test, function(index, obj) {
			  // $('#form_em_locality').append( $('<option></option>').val(obj).html(obj));
          // });
